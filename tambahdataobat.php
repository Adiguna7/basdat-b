                    ...
                    <form action="tambahdata.php" method="POST">
                        <ul>
                            ...
                            <li style="display: flex; justify-content: space-between;">
                                ...
                                <input type="text" name="kegunaan" id="kegunaan" autocomplete="off">
                            </li>
                            <br>
                            <li style="display: flex; justify-content: space-between;">
                                <label for="tersedia">Tersedia</label>
                                <input type="text" name="tersedia" id="tersedia" autocomplete="off">                
                            </li>                           
                            <br>
                            <?php
                                if(isset($_GET["input"])){
                            ...
                            <br>                            
                            <li>
                                <button type="submit" name="tambahdataobat">Tambah</button>
                            </li>
                        </ul>        
