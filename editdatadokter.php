        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $data = mysqli_query($koneksi, "SELECT * FROM doctor WHERE id = '$id' ");
                    ...
                    <form action="update.php" method="POST">
                        <ul>
                            ...
                            <li style="display: flex; justify-content: space-between;">
                                ...
                                <input type="text" name="alamat" id="alamat" autocomplete="off" value="<?php echo $d["alamat"]?>">
                            </li>
                            <br>
                            <li style="display: flex; justify-content: space-between;">
                                <label for="spesialis">Spesialis</label>
                                <input type="text" name="spesialis" id="spesialis" autocomplete="off" value="<?php echo $d["spesialis"]?>">                
                            </li>
                            <br>
                            <li style="display: flex; justify-content: space-between;">
                                <label for="free">Free</label>
                                <input type="text" name="free" id="free" autocomplete="off" value="<?php echo $d["free"]?>">                
                            </li>                            
                            <br>                           
                            <br>                            
                            <li>
                                <button type="submit" name="editdatadokter">Edit</button>
                            </li>
                        </ul>        
